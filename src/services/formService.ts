...
export class FormService {
  ...
  async createPersonalDetails(
    data: Omit<
      PersonalDetails,
      "personal_id" | "user_id" | "coach_user_id" | "created_at" | "updated_at"
    >,
  ): Promise<PersonalDetails> {
    const response = await apiService.post<PersonalDetails>(
      "/personal-details",
      data,
    );
  ...
  async getPersonalDetails(
  ...
  ): Promise<PaginatedResponse<PersonalDetails>> {
    ...
    const response = await apiService.get<PaginatedResponse<PersonalDetails>>(
      `/personal-details?${params}`,
    );
    if (response.success && response.data) {
      return response.data;
    }
  ...
  async getMyPersonalDetails(): Promise<PersonalDetails> {
    const response = await apiService.get<PersonalDetails>(
      "/personal-details/my",
    );
    if (response.success && response.data) {
      return response.data;
  ...
  async updatePersonalDetails(
    ...
    const response = await apiService.put<PersonalDetails>(
      `/personal-details/${personalId}`,
      data,
    );
    if (response.success && response.data) {
  ...
  async createEmployment(
    data: Omit<
      EmploymentDetails,
      "employment_id" | "created_at" | "updated_at"
    >,
  ): Promise<EmploymentDetails> {
    const response = await apiService.post<EmploymentDetails>(
      "/employment",
      data,
    );
    if (response.success && response.data) {
  ...
  async updateEmployment(
    ...
    const response = await apiService.put<EmploymentDetails>(
  ...
  async deleteEmployment(employmentId: string): Promise<void> {
    ...
    if (!response.success) {
      throw new Error(
        response.message || "Failed to delete employment details",
      );
    }
  }
  ...
  async createIncome(
    data: Omit<IncomeDetails, "income_id" | "created_at" | "updated_at">,
  ): Promise<IncomeDetails> {
  ...
  async updateIncome(
    incomeId: string,
    data: Partial<IncomeDetails>,
  ): Promise<IncomeDetails> {
    const response = await apiService.put<IncomeDetails>(
      `/income/${incomeId}`,
      data,
    );
    if (response.success && response.data) {
  ...
  async createExpenses(
    data: Omit<ExpensesDetails, "expenses_id" | "created_at" | "updated_at">,
  ...
  async getExpensesByUserId(userId: string): Promise<ExpensesDetails[]> {
    const response = await apiService.get<ExpensesDetails[]>(
  ...
  async updateExpenses(
    userId: string,
    data: Partial<ExpensesDetails>,
  ): Promise<ExpensesDetails> {
    const response = await apiService.put<ExpensesDetails>(
      `/expenses/${userId}`,
      data,
    );
    if (response.success && response.data) {
  ...
  async createAsset(
    data: Omit<Asset, "asset_id" | "created_at" | "updated_at">,
  ): Promise<Asset> {
  ...
  async createLiability(
    data: Omit<Liability, "liability_id" | "created_at" | "updated_at">,
  ): Promise<Liability> {
  ...
  async updateLiability(
    ...
    const response = await apiService.put<Liability>(
      `/liabilities/${liabilityId}`,
      data,
    );
    if (response.success && response.data) {
  ...
  async createFamilyMember(
    data: Omit<FamilyMember, "family_member_id" | "created_at" | "updated_at">,
  ...
  async getFamilyMembersByUserId(userId: string): Promise<FamilyMember[]> {
    const response = await apiService.get<FamilyMember[]>(
  ...
  async getFamilyMembersByUserAndRelation(
    userId: string,
    relation: FamilyRelation,
  ): Promise<FamilyMember[]> {
    const response = await apiService.get<FamilyMember[]>(
      `/family-members/user/${userId}/relation/${relation}`,
    );
    if (response.success && response.data) {
      return response.data;
    }
    throw new Error(
      response.message || "Failed to get family members by user and relation",
    );
  }

  async getFamilyMemberById(familyMemberId: string): Promise<FamilyMember> {
    const response = await apiService.get<FamilyMember>(
      `/family-members/user/${familyMemberId}`,
    );
  ...
  async deleteAllUserFamilyMembers(userId: string): Promise<void> {
    ...
    if (!response.success) {
      throw new Error(
        response.message || "Failed to delete all user family members",
      );
    }
  }
  ...
  async getCompletePerson(personalId: string): Promise<Person> {
    const response = await apiService.get<Person>(
    ...
    throw new Error(
      response.message || "Failed to get complete person profile",
    );
  }
