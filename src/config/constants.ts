...
export const API_CONFIG = {
  BASE_URL:
    import.meta.env.VITE_API_BASE_URL || "https://ywc-api.replit.app/api",
  TIMEOUT: 10000,
} as const;
...
export const TAX_RETURN_CONSENT_TITLE: string =
  "Consent for Tax Return Data Collection and Processing";
export const TAX_RETURN_CONSENT_DESCRIPTION: string =
  "The undersigned consents to the collection, processing, and transmission of personal tax-related data including income, expenses, deductions, and associated documents for the purpose of preparing and submitting income tax returns. The data may be shared with authorized tax advisors, tax offices, and electronic filing platforms in accordance with §87 AO and GDPR Art. 6 Para. 1 lit. b (performance of a contract) and lit. a (explicit consent). " +
...
export const ELECTRONIC_CONSENT_TITLE: string =
  "Consent for Electricity/Utility Tariff Comparison and Switching";
export const ELECTRONIC_CONSENT_DESCRIPTION: string =
  "I hereby authorize the collection and processing of my personal data (including name, address, consumption values, meter numbers, and prior utility contracts) for the purpose of comparing electricity and/or gas tariffs and facilitating a switch to a new provider. " +
...
export const INSURANCE_CONSENT_TITLE: string =
  "Consent for Insurance Applications and Comparison Services";
export const INSURANCE_CONSENT_DESCRIPTION: string =
  "I authorize the collection, processing, and sharing of my personal data including name, address, date of birth, employment status, income, and—if necessary—health data in the context of insurance applications (e.g., health, life, or liability insurance). " +
...
export const LOAN_CONSENT_TITLE: string =
  "Consent for Loan Application and Credit Intermediary";
export const LOAN_CONSENT_DESCRIPTION: string =
  "I authorize the collecting entity (e.g., credit broker or financial institution) to gather, store, and transmit my financial data (employment details, credit obligations, income, asset declarations, and SCHUFA score) for the purpose of applying for and mediating loan offers. " +
...
export const REAL_ESTATE_CONSENT_TITLE: string =
  "Consent for Real Estate Purchase and Financing Support";
export const REAL_ESTATE_CONSENT_DESCRIPTION: string =
  "I consent to the processing of personal and financial data in connection with property searches, real estate transactions, and mortgage financing. This includes identification data, income and asset proof, SCHUFA data, and property-related information. " +
...
export const DATA_STORAGE_CONSENT_TITLE: string =
  "Consent for Data Storage and Processing";
export const DATA_STORAGE_CONSENT_DESCRIPTION: string =
  "I authorize the storage and processing of my submitted personal and financial data through certified third-party service providers (e.g., cloud platforms, CRM tools, document verification software). These processors are contractually bound by Art. 28 GDPR to maintain data security and confidentiality. " +
