...
export default function NotificationItem({ notification }: NotificationItemProps) {
  ...
  const getNotificationStyles = () => {
    const baseStyles = 'p-4 rounded-lg shadow-lg border transform transition-all duration-300 ';
    ...
    switch (notification.type) {
      ...
      default:
        return baseStyles + 'bg-gray-50 border-gray-200 text-gray-800 dark:bg-gray-900/20 dark:border-gray-800 dark:text-gray-300';
    }
  };
